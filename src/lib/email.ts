  ...
  <div style="max-width: 600px; margin: 0 auto; background: white; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
    ...
    <div style="padding: 24px;">
      ...
      <div style="background: linear-gradient(135deg, #1948b3 0%, #366be3 100%); padding: 20px; border-radius: 12px; text-align: center;">
        ...
        <a href="https://mynextrideontario.ca/admin" style="display: inline-block; background: #ecc979; color: #1948b3; padding: 12px 32px; border-radius: 8px; text-decoration: none; font-weight: 700;">View Dashboard</a>
      </div>
    </div>
  </div>
</body>
